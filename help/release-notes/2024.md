...
| Funktion | Beschreibung | [Rollout-Beginn](releases.md) | [Allgemeine Verfügbarkeit](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Die Streaming-Mediensammlung: Senden von Roku-Daten an das Adobe Experience Platform-Edge Network** | Wenn Sie [Streaming-Mediensammlung mit Experience Platform Edge installieren](https://experienceleague.adobe.com/de/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge) können Sie jetzt die Adobe Experience Platform Roku-SDK verwenden, um Streaming-Mediendaten an Adobe Experience Platform zu senden. |  | 12. April 2024 |
