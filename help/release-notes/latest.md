...
**Zuletzt aktualisiert**: Dienstag, 31. März 2025
...
| **„Nur Data Warehouse“-Dimensionen** | Ab Mai 2025 wird Adobe damit beginnen, bestimmte Dimensionen (benutzerdefinierte Variablen wie eVars und Props) als „nur Data Warehouse&quot; festzulegen. Dies gilt für Dimensionen mit den folgenden Eigenschaften:<ul><li> Über einen Zeitraum von mehreren Monaten erreicht die Variable innerhalb der ersten Tage des Monats das niedrige Traffic-Limit.</li><li>> 90 % der übergebenen Werte werden nur einmal im Monat angezeigt.</li></ul>Beispiele sind Dimensionen mit Zeitstempeln, UUIDs oder anderen Daten, die eine extrem hohe Kardinalität aufweisen und bei denen eindeutige neue Werte für fast jeden Treffer (oder Besuch oder Besucher) im Laufe des Monats übergeben werden. Diese Dimensionen überschreiten normalerweise sehr schnell die Low-Traffic-Grenzwerte, und nur ein sehr kleiner Teil der Werte ist in Analysis Workspace zu melden. Berichte, die diese Dimensionen verwenden, sind dadurch verwirrend, da sie keine nützlichen oder genauen Informationen enthalten. Diese Dimensionen entsprechen nicht dem Zweck der Funktion für geringen Traffic bzw. profitieren nicht von dieser Funktion, die eine Möglichkeit bieten soll, Berichte zu Werten zu erstellen, die „beliebt“ werden, nachdem die Dimension die niedrigen Traffic-Grenzwerte im Laufe des Monats überschritten hat. [Weitere Informationen](https://experienceleague.adobe.com/en/docs/analytics/technotes/low-traffic.)<p>Dimensionen, die als „Nur Data Warehouse&quot; markiert sind, sind in Analysis Workspace nicht für das Reporting verfügbar. Sie stehen jedoch weiterhin für das Reporting über Data Warehouse zur Verfügung, da niedrige Traffic-Beschränkungen hier nicht gelten.<p>Dies bedeutet nicht, dass jede Dimension, die die niedrigen Traffic-Grenzwerte erreicht hat, als „Nur Data Warehouse&quot; gekennzeichnet werden kann. Die meisten Dimensionen, die die niedrigen Traffic-Grenzwerte erreichen, erfüllen tatsächlich die Absicht der Funktion für geringen Traffic:<ul><li>Die meisten übergebenen Werte sind nicht eindeutig.</li><li>Gemeinsame Werte kommen weiter ins Spiel, nachdem die verkehrsarmen Grenzwerte im Laufe des Monats erreicht wurden.</li><li>Neue „beliebte“ Werte können weiterhin auftreten.</li></ul>Nur die Dimensionen, in denen fast alle übergebenen Werte neu und eindeutig sind, werden als „Nur Data Warehouse&quot; markiert. Angesichts der Einzigartigkeit der in diesen Situationen erfassten Daten ist die Erhöhung der niedrigen Traffic-Limits keine Lösung. | | Mai 2025 |
