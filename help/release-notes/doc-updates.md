...
* Informationen zu Streaming-Mediendiensten finden Sie unter [Messen von Audio und Video in Analytics](https://experienceleague.adobe.com/de/docs/media-analytics/using/media-overview).
...
| **Februar 2026** |  |
| Informationen zur Verwendung von Geo- und Technologieberichten wurden hinzugefügt | Es wurden Informationen zu Unterschieden bei der Verwendung von Geo- und Technologieberichten [über verschiedene Analytics-Produkte hinweg](/help/analyze/get-started/analytics-product-comparison.md) Artikel hinzugefügt. |
| **Januar 2026** | |
| Rule Builder für Klassifizierungssätze | Dokumentation für die neue Funktion [Regel-Builder“ in Klassifizierungssätzen](/help/components/classifications/sets/manage/rules.md). |
| Gerätediagramm | Verweise auf die Funktion [Eingestellte Gerätediagramm-Funktion](https://experienceleague.adobe.com/de/docs/discontinued/using/device-graph) wurden entfernt. |
...
| **September 2025** | |
| Optimierungen der Besucheridentifizierung | Best Practices bezüglich der Besucheridentifizierung wurden klarer formuliert, wobei der Schwerpunkt auf dem Zweck der Variablen „`trackingServer`“ und „[`trackingServerSecure`](/help/implement/vars/config-vars/trackingserversecure.md)“ in AppMeasurement lag. |
| **August 2025** | |
...
| `cookieDomainPeriods` wurde eingestellt | Nachdem AppMeasurement nun automatisch die richtige Domain erkennt, für die Cookies gesetzt werden sollen, wird die Variable [`cookieDomainPeriods`](/help/implement/vars/config-vars/configuration-variables.md#retired-configuration-variables) nicht mehr unterstützt. |
...
| **April 2024** | |
| Dokumentation zu „Inhaberin oder Inhaber“ in Klassifizierungssätzen entfernt | Der Filter und die Spalte „Inhaberin oder Inhaber“ wurden aus dem [Klassifizierungssatz-Manager](/help/components/classifications/sets/manage-sets.md) entfernt und das Feld „Inhaberin oder Inhaber“ wurde aus den [Klassifizierungssatzeinstellungen](/help/components/classifications/sets/manage/settings.md) entfernt. <p>Die Dokumentation wurde aktualisiert, dabei wurden dieser Filter, diese Spalte und dieses Feld entfernt.</p> |
...
| Verbesserungen an der Dokumentation für die Streaming-Mediensammlung | Es wurden die folgenden Verbesserungen an der Dokumentation für die Streaming-Mediensammlung vorgenommen: <ul><li>Der [allgemeine Übersicht](https://experienceleague.adobe.com/de/docs/media-analytics/using/media-overview) wurde aktualisiert, um mehr Klarheit zu schaffen und Informationen in Bezug auf Customer Journey Analytics aufzunehmen.</li><li>Die [Implementierungsübersicht](https://experienceleague.adobe.com/de/docs/media-analytics/using/implementation/overview) wurde aktualisiert, um deutlich zwischen Edge-Implementierungen und reinen Analytics-Implementierungen zu unterscheiden. Es wurden außerdem Diagramme zur Veranschaulichung der verschiedenen Implementierungsmethoden hinzugefügt.</li><li>Es wurden spezifische Voraussetzungen für [Edge-Implementierungen](https://experienceleague.adobe.com/de/docs/media-analytics/using/implementation/edge-recommended/prerequisites-edge) und [reine Analytics-Implementierungen](https://experienceleague.adobe.com/de/docs/media-analytics/using/implementation/analytics-only/prerequisites-analytics) hinzugefügt. Außerdem wurden die [allgemeinen Voraussetzungen](https://experienceleague.adobe.com/de/docs/media-analytics/using/getting-started/prereqs) aktualisiert.</li><li>Es wurden Tabellen im Artikel [Abrufen von Medien-SDKs, Erweiterungen mithilfe von Tags und OTT-SDKs](https://experienceleague.adobe.com/de/docs/media-analytics/using/getting-started/download-sdks) aktualisiert, indem neue Spalten für *unterstützte Lösungen* und *Implementierungsmethode* aufgenommen wurden.</li><li>Inhalt und Organisation von Artikeln im Bereich [Implementierung](https://experienceleague.adobe.com/de/docs/media-analytics/using/implementation/overview) der Dokumentation wurden optimiert. Dazu gehörte die Kategorisierung von Implementierungen nach Edge-Implementierungen und reinen Analytics-Implementierungen.</li><li>Eine zusätzliche Hierarchieebene wurde entfernt, die unter [Tracking](https://experienceleague.adobe.com/de/docs/media-analytics/using/tracking/track-core-overview) nicht benötigt wurde, und in diesem Abschnitt wurden Umleitungen für geänderte URLs hinzugefügt.</li><ul> |
| **Juli 2023** | |
...
| 10. Oktober 2019 | Aktualisierung der Gesamtwerte einer Freiformtabelle: Sie enthalten nun zwei Summen, und zwar eine **[!UICONTROL Tabellensumme]** und einen **[!UICONTROL Gesamtwert]**. In der Tabellenzeile „Gesamt“ werden angewendete [Berichtsfilter](/help/analyze/analysis-workspace/visualizations/freeform-table/filter-and-sort.md) berücksichtigt. Zuvor wirkte sich nur die Segmentierung auf die Gesamtwerte aus. [Weitere &#x200B;](/help/analyze/analysis-workspace/visualizations/freeform-table/workspace-totals.md)<br/>Darüber hinaus wurden die Optionen **[!UICONTROL Summen anzeigen]** und **[!UICONTROL Gesamtsumme anzeigen]** zu **[!UICONTROL Spalteneinstellungen]**.<br/> hinzugefügt.Mit dieser Änderung an Freiformsummen werden abhängige Visualisierungen aktualisiert (z. B. verknüpfte **[!UICONTROL Zusammenfassungszahl]** Visualisierungen) sowie exportierte CSV- und PDF-Daten. |
...
| &#x200B;13. Juni 2019 | In Arbeitsbereich wurden neue vordefinierte Filter zum Suchfeld in der linken Leiste hinzugefügt. Neben dem, was Sie heute sehen (Dimensionen, Metriken, Genehmigt usw.), wurden neue Filter wie berechnete Metriken, Kundenattribute, eVars, Props, Video usw. hinzugefügt, um das Auffinden der benötigten Komponenten zu erleichtern. |
| &#x200B;4. Juni 2019 | Neues Handbuch mit dem Titel Wechsel von einer Analyseplattform eines Drittanbieters zu Adobe Analytics. |
