...
Analytics zeigt in allen Berichten und Projekten einen standardmäßigen (nativen) Satz von Metriken an, es sei denn, ein Benutzer wählt einen benutzerdefinierten Satz von Metriken aus. Die ausgewählten Metriken werden bei allen Benutzern der zugehörigen Report Suite angezeigt. Sie können nicht mehrere Standardmetriken einer Report Suite gleichzeitig aktualisieren. Diese Einstellungen spiegeln nicht unbedingt die Reihenfolge wider, in der die Standardmetriken angezeigt werden.
