---
description: In den Abschnitten Dauerhafter Traffic können Sie die erwarteten Traffic-Niveaus ändern, sodass Adobe Ressourcen neu zuweisen kann, um das neue Traffic-Niveau zu verarbeiten.
...
# Dauerhafte Traffic-Zunahme angeben

Sie können die erwarteten Traffic-Niveaus ändern, sodass Adobe Ressourcen neu zuweisen kann, um das neue Traffic-Niveau zu verarbeiten. (Sie können auch die [Traffic-Spitze planen](/help/admin/tools/manage-rs/edit-settings/c-traffic-management/t-traffic-schedule-spike.md), wenn Sie Ressourcen vorübergehend neu zuweisen möchten.)
