---
description: Eine Report Suite definiert die vollständige, unabhängige Berichterstellung über eine bestimmte Website, eine Gruppe von Websites oder eine Teilmenge von Webseiten.
...
* Einen Teil oder eine Teilmenge einer einzelnen Website

* Ein globales Segment, das aus den Zahlen mehrerer Sites einen Gesamtwert erzeugt

Analytics-Lösungen aggregieren diese Datenspeicher und erstellen Berichte darüber. Mit dem Admin Report Suite Manager können Sie die Regeln definieren, die steuern, wie Daten in einer Report Suite verarbeitet werden.
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Ermöglicht das Auffinden einer bestimmten Report Suite in der Report Suite-Liste. Das Such-Tool bietet sowohl einfache namensbasierte Suche als auch eine erweiterte Suchseite für ausführliche Suchvorgänge. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> Gruppen</span> </td> 
   <td colname="col2"> <p>Ermöglicht das Organisieren von Report Suites in benutzerdefinierten Gruppen. Sie können schnell auf mehrere Report Suites zugreifen, die ähnliche Einstellungen aufweisen oder die Sie häufig gemeinsam bearbeiten. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Eine Datenaggregation ist eine einzelne Report Suite, die die Rückverfolgungsdaten verschiedener anderer Report Suites kombiniert. </p> <p>Siehe <a href="/help/admin/tools/manage-rs/rollup-report-suite.md"> Datenaggregations-Report Suites</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">Siehe <a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">Neue Report Suite</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Daran erkennen Sie die Report Suites in den Admin Tools sowie in der Dropdown-Liste „Report Suite“ in der Kopfzeile der Marketing-Berichte. </p> <p>Siehe <a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">Neue Report Suite</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> Basis-URL</span> </td> 
   <td colname="col2"> <p>Legt die Basisdomäne für die Report Suite fest. </p> <p>Siehe <a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">Neue Report Suite</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
