...
2. Gehen Sie zu **[!UICONTROL Analytics]** > **[!UICONTROL Admin]** > **[!UICONTROL Alle Administratoren]** > **[!UICONTROL Datenkonfiguration und -erfassung]** > **[!UICONTROL Data Governance]**.
   ...
   >[!NOTE]
   >
   >Wenn dieser Menüpunkt nicht angezeigt wird, müssen Sie sich zu einem [Produktprofil in der Admin Console](/help/admin/admin-console/permissions/product-profile.md) hinzufügen lassen, das über Berechtigungen für diese Funktion verfügt, oder Zugriff auf eine Report Suite in der Admin Console erhalten haben.
...
1. Der folgende Bildschirm enthält den Variablennamen, die aktuell angewendeten Kennzeichnungen, die Sie kopieren möchten, die Report Suites und deren IDs sowie Informationen darüber, ob die Einstellungen in den Ziel-Report-Suites passend sind.
   ...
   >[!IMPORTANT]
   >
   >Beachten Sie, dass alle von Ihnen ausgewählten Report Suites Ihrer CX Enterprise-Organisation zugeordnet werden müssen.
...
Siehe [Zuweisen oder Bearbeiten von Report-Suite-Datenschutzkennzeichnungen](/help/admin/tools/privacy-labeling/labeling-overview.md).
