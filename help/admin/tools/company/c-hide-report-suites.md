...
Wenn Sie nicht möchten, dass Ihnen und Ihren Benutzern eine Report Suite zur Verfügung steht, können Sie sie ausblenden. Mögliche Gründe, warum Sie eine Report Suite ausblenden möchten, sind Änderungen an der Implementierung oder die versehentliche Erstellung einer Report Suite.

Durch das Ausblenden einer Report Suite wird verhindert, dass diese im Dropdown-Menü der Report Suite-Auswahl, in den Admin Tools oder an einer anderen Stelle angezeigt wird, an der Report Suites angezeigt werden. Dadurch wird der Zugriff auf die Daten der Report Suite über die Adobe Analytics-Benutzeroberflächen verhindert, bis die Report Suite eingeblendet wird.
