...
+ Support-Informationen: Auf der Seite „Support-Informationen“ werden die Support-Informationen verwaltet, die in Adobe Analytics angezeigt werden, wenn Sie sich an einen Administrator wenden müssen. Sie haben beispielsweise keinen Zugriff auf eine Funktion, auf die Sie zugreifen möchten.
...
+ [Zugriffsebenen für Funktionen anzeigen](feature-access-levels.md)
+ [Web-Services](web-services-admin.md)
+ Leistungsoptimierung für China: Die Leistungsoptimierung von Adobe auf dem chinesischen Festland ermöglicht es Kunden in China, Daten direkt an den chinesischen Edge-Knoten zu senden und nicht an andere Standorte weltweit. Dies verbessert die Seitenladezeiten und die Datengenauigkeit im Vergleich zum Senden der Daten an Knoten außerhalb Chinas. Weitere Informationen finden Sie im Abschnitt Häufig gestellte Fragen in der Benutzeroberfläche .