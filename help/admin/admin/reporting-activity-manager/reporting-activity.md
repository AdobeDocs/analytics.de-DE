...
* **Y-Achse**: Die Anzahl der Benutzenden, die Berichtsanfragen gestellt haben, für jede Minute.
  ...
  ![Diagramm „Unterschiedliche Benutzende“](assets/distinct-users-graph.png)
...
* **Y-Achse**: Die Anzahl der verarbeiteten Anfragen (grün) und der in die Warteschlange gestellten Anfragen (violett) für jede Minute.
  ...
  ![Diagramm „Anfragen“](assets/requests-graph.png)
...
* **Y-Achse**: Die durchschnittliche Wartezeit (in Sekunden).
  ...
  ![Diagramm „In Warteschlange“](assets/queueing-graph.png)
...
| Spalte | Beschreibung |
| --- | --- |
| [!UICONTROL **Benutzer**] | Die Person, die die Anfrage initiiert hat. Wenn der Wert dieser Spalte [!UICONTROL **Nicht erkannt**] lautet, bedeutet dies, dass sich die Benutzerin bzw. der Benutzer in einer Unternehmensanmeldung befindet, für die Sie keine Admin-Berechtigungen haben. |
...
| Spalte | Beschreibung |
| --- | --- |
| [!UICONTROL **Anwendung**] | Die Anwendung, in der die Anfragen initiiert wurden. |
