...
**[!UICONTROL Konversionsvariablensyntax]** bedeutet, dass Sie den Wert der eVar in einer eigenen Variablen festlegen. Bei der Konversionsvariablensyntax wird beispielsweise der `eVar1` -Wert der &quot;internen Keyword-Suche&quot;innerhalb des Seiten-Codes (oder des AppMeasurement-Codes, des Adobe Experience Platform Web SDK-Codes usw.) wie folgt festgelegt:
