...
+ Adobe Admin Console {#admin-console} {#admin-console}
   ...
   + Zusammenfassung der Berechtigungen für Analytics-Tools {#permissions} {#permissions}
...
+ Admin-Tools für Analytics {#admin-tools} {#admin-tools}
   ...
   + Berichterstellung für Activity Manager {#reporting-activity-manager} {#reporting-activity-manager}
   ...
   + Komponenten-Migration {#component-migration} {#component-migration}
   ...
   + Report Suite Manager {#manage-report-suites} {#manage-report-suites}
      + Bearbeiten der Einstellungen einer Report Suite {#edit-report-suite} {#edit-report-suite}
         + Allgemein {#report-suite-general} {#report-suite-general}
            ...
            + Erkennung von Paid Search {#paid-search-detection} {#paid-search-detection}
            ...
            + Verarbeitungsregeln {#c-processing-rules} {#c-processing-rules}
               ...
               + Verarbeitungsregeln {#c-processing-rules-configuration} {#c-processing-rules-configuration}
               ...
               + Beispiele für Verarbeitungsregeln {#processing-rules-examples} {#processing-rules-examples}
            ...
            + Bot-Regeln {#bot-removal} {#bot-removal}
            ...
            + Server-seitige Weiterleitung {#server-side-forwarding} {#server-side-forwarding}
         ...
         + Traffic {#traffic-variables} {#traffic-variables}
         ...
         + Konversion {#conversion-variables} {#conversion-variables}
            ...
            + Unique-Visitor-Variable {#unique-visitor-variable} {#unique-visitor-variable}
         ...
         + Marketing-Kanäle {#marketing-channels} {#marketing-channels}
         ...
         + App-Verwaltung {#app-management} {#app-management}
         ...
         + Document Cloud-Verwaltung {#doc-cloud-mgt} {#doc-cloud-mgt}
         ...
         + Echtzeit {#real-time-reports} {#real-time-reports}
      ...
      + Neue Report Suite {#c-new-report-suite} {#c-new-report-suite}
      ...
      + Report Suite-Vorlagen {#report-suite-templates} {#report-suite-templates}
   ...
   + Unternehmenseinstellungen {#company-settings} {#company-settings}
   ...
   + Datenschutzkennzeichnungen für Data Governance {#data-governance} {#data-governance}
      ...
      + Datenkennzeichnung {#data-labels} {#data-labels}
   ...
   + Nutzung der Server-Aufrufe {#server-call-usage} {#server-call-usage}
   ...
   + Verwalten von Benutzenden und Produkten (veraltet) {#user-product-management} {#user-product-management}
      ...
      + Migrieren von Benutzern zur Adobe Admin Console {#migrate-users} {#migrate-users}
