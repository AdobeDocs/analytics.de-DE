...
>[!IMPORTANT]
>
>Wenn Sie Ereignisse im Editor für benutzerdefinierten Code der Analytics-Erweiterung festlegen, müssen Sie das Ereignis auch mit benutzerdefiniertem Code in `linkTrackEvents` einbeziehen.
