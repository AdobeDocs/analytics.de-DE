...
>[!IMPORTANT]
>
>Dieses Plug-in wird nicht mehr unterstützt. Der Code verwendet die [`PerformanceTiming`](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceTiming)-Schnittstelle, die in den meisten modernen Browsern veraltet ist.
