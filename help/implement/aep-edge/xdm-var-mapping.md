...
Wenn Ihr Unternehmen plant, auf Customer Journey Analytics umzusteigen, empfiehlt Adobe, stattdessen das `data`-Objekt zu verwenden, um Daten direkt an Adobe Analytics zu senden, ohne einem Schema zu entsprechen. Diese Strategie ermöglicht es Ihrem Unternehmen, Ihr eigenes Schema zu verwenden, anstatt die [!UICONTROL Adobe Analytics ExperienceEvent-Vorlage] zu verwenden (was weniger auf Customer Journey Analytics anwendbar ist). Siehe [Zuordnung von Datenobjektvariablen zu Adobe Analytics](data-var-mapping.md) für eine ähnliche Zuordnungstabelle.
...
| `xdm.media.mediaTimed.completes.value` | Die Metrik &quot;[ abgeschlossen](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-complete) für Streaming-Medien |
| `xdm.media.mediaTimed.dropBeforeStart.value` | `c.a.media.view`, `c.a.media.timePlayed`, `c.a.media.play` |
| `xdm.media.mediaTimed.federated.value` | Die Metrik &quot;[&quot; ](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#federated-data) Streaming-Medien. |
| `xdm.media.mediaTimed.firstQuartiles.value` | Die Metrik für Streaming-[ (25 % Fortschrittsmarkierung](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#twenty-five-progress-marker). |
| `xdm.media.mediaTimed.mediaSegmentView.value` | Die Metrik für Streaming-[ (Inhaltssegmentansichten](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-segment-views). |
| `xdm.media.mediaTimed.midpoints.value` | Die Metrik für Streaming-Medien [50 % Fortschrittsmarkierung](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#fifty-progress-marker). |
| `xdm.media.mediaTimed.pauseTime.value` | Die Metrik Streaming-Medien [Pausierung - ](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#total-pause-duration). |
| `xdm.media.mediaTimed.pauses.value` | Die Metrik Streaming-Medien [Pause-Ereignisse](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#pause-events). |
| `xdm.mediaCollection.sessionDetails.assetID` | Die Dimension Streaming-Medien [Asset-ID](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#asset-id). |
| `xdm.mediaCollection.sessionDetails.friendlyName` | Die Dimension Streaming-Medien [Videoname](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#video-name). |
| `xdm.mediaCollection.sessionDetails.originator` | Die Dimension Streaming-Medien [Urheber](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#originator). |
| `xdm.mediaCollection.sessionDetails.episode` | Die Dimension Streaming-Medien [Folge](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#episode). |
| `xdm.mediaCollection.sessionDetails.genre` | Die Dimension Streaming-Medien [Genre](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#genre). |
| `xdm.mediaCollection.sessionDetails.rating` | Die Dimension Streaming-Medien [Inhaltsbewertung](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-rating). |
| `xdm.mediaCollection.sessionDetails.season` | Die Dimension Streaming-Medien [Staffel](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#season). |
| `xdm.mediaCollection.sessionDetails.name` | Die Dimension Streaming-Medien [Inhalts-ID](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-id). |
| `xdm.mediaCollection.sessionDetails.show` | Die Dimension Streaming-Medien [Anzeigen](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#show). |
| `xdm.mediaCollection.sessionDetails.showType` | Die Dimension Streaming-Medien [Sendungstyp](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#show-type). |
| `xdm.mediaCollection.sessionDetails.length` | Die Dimension Streaming-Medien [Videolänge](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#video-length). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.@id` | Die Dimension Streaming-Medien [Mediensitzungs-ID](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#media-session-id). |
| `xdm.mediaCollection.sessionDetails.channel` | Die Dimension Streaming-Medien [Inhaltskanal](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-channel). |
| `xdm.mediaCollection.sessionDetails.contentType` | Die Dimension Streaming-Medien [Content-Typ](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-type). |
| `xdm.mediaCollection.sessionDetails.network` | Die Dimension Streaming-Medien [Netzwerk](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#network). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`mediaSegmentView.value` | Die Dimension „Streaming[Medien-](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-segment)&quot; |
| `xdm.mediaCollection.sessionDetails.playerName` | Die Dimension Streaming-Medien [Name des Inhalts](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-player-name). |
| `xdm.mediaCollection.sessionDetails.appVersion` | Die Streaming-Medien-Dimension [SDK Version](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#sdk-version). |
| `xdm.mediaCollection.sessionDetails.feed` | Die Dimension „Streaming[Medien-Feed-Typ](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#media-feed-type). |
| `xdm.mediaCollection.sessionDetails.streamFormat` | Die Dimension Streaming-Medien [Stream-Format](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#stream-format). |
...
| `xdm.mediaCollection.sessionDetails.hasResume` | Die Metrik für Streaming-Medien [Inhaltswiederaufnahmen](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-resumes). |
| `xdm.media.mediaTimed.starts.value` | Die Metrik Streaming-Medien [Medienstarts](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#media-starts). |
| `xdm.media.mediaTimed.thirdQuartiles.value` | Die Metrik für Streaming-[ (75 % Fortschrittsmarkierung](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#seventy-five-progress-marker). |
| `xdm.media.mediaTimed.timePlayed.value` | Die Metrik Streaming-Medien [Besuchszeit für Inhalt](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#content-time-spent). |
| `xdm.media.mediaTimed.totalTimePlayed.value` | Die Metrik „Besuchszeit für Streaming[Medien](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=de#media-time-spent). |
...
Alle XDM-Feldelemente, die nicht automatisch zugeordnet werden, werden als Kontextdaten mit dem Präfix an Adobe Analytics gesendet. `a.x.` Sie können diese Kontextdatenvariable dann mithilfe von [Verarbeitungsregeln“ der gewünschten Analytics-](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/processing-rules/processing-rules.html?lang=de) zuordnen. Angenommen, Sie senden das folgende Ereignis:
