...
* [AppMeasurement zur Web SDK JavaScript Library](appmeasurement-to-web-sdk.md): Ein reibungsloser und methodischer Ansatz für die Migration zur Web SDK, außer es werden keine Tags verwendet. Stattdessen können Sie die Adobe Analytics-Datenerfassungsbibliothek (`AppMeasurement.js`) manuell entfernen und durch die Web-SDK-JavaScript-Bibliothek (`alloy.js`) ersetzen.
