...
| **4<sup>th</sup>** | `fid` | Der Besucher verfügt über ein vorhandenes [`s_fid`](https://experienceleague.adobe.com/de/docs/core-services/interface/data-collection/cookies/analytics)-Cookie oder wenn `aid` und `mid` aus irgendeinem Grund nicht festgelegt werden konnten. |
