...
| --- | --- | --- |
| `aamlh` | Keine | Audience Manager-Standorthinweis. Wird bei der Integration von freigegebenen CX Enterprise-Profilen verwendet. |
| `aamb` | Keine | Audience Manager Blob. Wird bei der Integration von freigegebenen CX Enterprise-Profilen verwendet. |
...
| `mid` | Keine | CX Enterprise-Besucher-ID. |
