...
3. **[!UICONTROL Verweisende Domain]** und **[!UICONTROL Vorhanden]** und **[!UICONTROL Verweis stimmt nicht mit internen URL-Filtern überein]**.
...
* **Sitzungstimeout**: Ein Besucher ruft die Website auf und lässt die Registerkarte dann in seinem Browser geöffnet, um sie später erneut zu verwenden. Der Interaktionszeitraum der Besuchenden läuft ab (oder die Cookies werden freiwillig gelöscht), und die geöffnete Registerkarte wird verwendet, um die Website erneut zu besuchen. Da die verweisende URL eine interne Domain ist, wird der Besuch als Sitzungsaktualisierung klassifiziert.
...
* **Lange Ladezeiten der Entrypage**: Ein Besucher landet auf Seite A mit viel Inhalt, und der Adobe Analytics-Code befindet sich unten auf der Seite. Bevor der gesamte Inhalt (einschließlich Adobe Analytics-Bildanforderungen) geladen werden kann, klicken Besuchende auf Seite B. Seite B löst ihre Adobe Analytics-Bildanforderung aus. Da die Bildanforderung von Seite A nie geladen wurde, erscheint die zweite Seite als erster Treffer des Besuchs in Adobe Analytics, wobei Seite A als Referrer dient. Der Besuch wird als Sitzungsaktualisierung klassifiziert.
