...
Wann sollten Sie Segmente für das gesamte Unternehmen im Vergleich zu einer Gruppe von Benutzern oder Einzelpersonen freigeben? Im Folgenden finden Sie einige Best Practices, an denen Sie sich orientieren können:
