...
| --- | --- | --- |
| Segmente werden angewendet | Eigene Segmente oder freigegebene Segmente. Sie können jedoch jedes Segment von jedem Benutzer für sich freigeben, um es zu verwenden | Nur eigene Segmente oder freigegebene Segmente |
