...
So definieren Sie das Schema für einen Klassifizierungssatz:

1. Wählen **[!UICONTROL Manager Klassifizierungssätze]** Klassifizierungssatz aus, für den Sie das Schema bearbeiten möchten.
1. Wählen Sie **[!UICONTROL Dialogfeld „Klassifizierungssatz _(_]**) die Registerkarte Schema aus. Diese Registerkarte besteht aus den folgenden Elementen der Benutzeroberfläche:
...
| **[!UICONTROL Identitätsname]** | Der abgeleitete Name durch das System für die Klassifizierung. |
...
Geben **[!UICONTROL im Dialogfeld _Neue Klassifizierung für Klassifizierungssatz hinzufügen_]**den **[!UICONTROL Klassifizierungsnamen]**ein und wählen Sie **[!UICONTROL Hinzufügen]**. Die Klassifizierung wird der Liste hinzugefügt.
...
Im Dialogfeld **[!UICONTROL Daten für _Klassifizierungssatz herunterladen_]**:
...
1. Um auszuwählen, welche Daten zurückgegeben werden sollen, wählen Sie eine Option unter **[!UICONTROL Daten zurückgegeben]** aus.
   ...
   * **[!UICONTROL Alle Spalten leer]** Gibt eine Spalte mit Schlüsselwerten für die vorhandenen Klassifizierungsdaten zurück. und Spalten ohne Wert für Klassifizierungsdaten, für die kein Wert vorhanden ist.
...
1. Wählen Sie **[!UICONTROL Herunterladen]** aus, um die Klassifizierungsdaten herunterzuladen. Sie finden die heruntergeladene Datei im Standard-Download-Verzeichnis Ihres Browsers und die Datei heißt <code><i>Klassifizierungssatz</i>.<i>json</i>|<i>csv</i>|<i>tsv</i></code>  Wenn die Datei bereits vorhanden ist, eine Sequenznummer <code>(<i>x</i>)</code> wird dem Dateinamen hinzugefügt.<br/>Wenn Sie Optionen angegeben haben, die keine Daten zurückgeben, wird ein Dialogfeld **[!UICONTROL Hinweis]** angezeigt, in dem Sie aufgefordert werden, die Optionen für den Datumsbereich und die zurückgegebenen Daten zu ändern.
...
Im Dialogfeld **[!UICONTROL Vorlage für _Klassifizierungssatz herunterladen_]**:
...
Im Dialogfeld **[!UICONTROL Aufnahme-Speicherort zuordnen/aktualisieren _Klassifizierungssatz_]**:
...
1. Um ein Trennzeichen auszuwählen, wählen Sie eine Option aus **[!UICONTROL Listentrennzeichen]**. Die Optionen sind:
   * **[!UICONTROL Komma ,]**
   * **[!UICONTROL Semikolon ;]**
...
In der Aktionsleiste werden die Aktionen angezeigt, die für den ausgewählten Klassifizierungssatz verfügbar sind. Verfügbare Optionen sind:
...
| ![Umbenennen](/help/assets/icons/Rename.svg) | **[!UICONTROL Umbenennen]** | Benennen Sie eine Klassifizierung um. Geben **[!UICONTROL im Dialogfeld &quot;_:_]**&quot; einen neuen Namen ein und wählen Sie **[!UICONTROL Umbenennen]**. |
| ![Löschen](/help/assets/icons/Delete.svg) | **[!UICONTROL Löschen]** | Löschen eines Klassifizierungssatzes. Das **[!UICONTROL Löschen _Klassifizierung_]**wird angezeigt. Wählen Sie **[!UICONTROL Löschen]**aus, um den Klassifizierungssatz zu löschen. |
