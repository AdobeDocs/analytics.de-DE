...
1. Wählen Sie **[!UICONTROL Dialogfeld „Klassifizierungssatz _(_]**) die Registerkarte **[!UICONTROL Schema]**aus. Diese Registerkarte besteht aus den folgenden Elementen der Benutzeroberfläche:
