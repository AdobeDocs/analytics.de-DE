...
1. Wählen Sie **[!UICONTROL Dialogfeld „Klassifizierungssatz _(Klassifizierungssatzname_]**die Registerkarte **[!UICONTROL Regeln]**aus.
   ...
   * Wenn Sie zum ersten Mal auf **[!UICONTROL Rules]**-Oberfläche für einen Klassifizierungssatz zugreifen oder sich bisher entschieden haben, weiterhin die alte Rule Builder-Benutzeroberfläche zu verwenden, wird ein Dialogfeld angezeigt, in dem Sie auswählen können, wie Sie beginnen möchten.

     ![Regeln für die Migration](assets/rules-migration.png)
