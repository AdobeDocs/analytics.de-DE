...
Der Warnhinweis-Manager ist wie der [Segment-Manager](/help/components/segmentation/segmentation-workflow/seg-manage.md) und der [Manager für berechnete Metriken](/help/components/c-calcmetrics/c-workflow/cm-workflow/cm-manager.md) strukturiert.
