...
* Das private Diagramm nutzt dieselben ID-Synchronisierungen wie die von der Funktion [Kundenattribute](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html?lang=de#customer-attributes) in Experience Cloud und Adobe Analytics verwendeten. Virtual Report Suites der geräteübergreifenden Analyse (unabhängig davon, ob sie auf privatem Diagramm oder feldbasiertem Stitching basieren) sind jedoch nicht mit der übrigen Funktion für Kundenattribute kompatibel. Mit anderen Worten: Auf Kundenattributen basierende Dimensionen sind nicht für die Verwendung mit Virtual Report Suites der geräteübergreifenden Analyse verfügbar.
