...
Adobe generiert automatisch eine Besucher-ID für jeden Besucher. Dieser Wert ist derselbe wie der verkettete Wert der Spalten `visid_high` und `visid_low` in Daten-Feeds. Siehe [Datenspaltenreferenz](../../export/analytics-data-feed/c-df-contents/datafeeds-reference.md) für weitere Informationen.
