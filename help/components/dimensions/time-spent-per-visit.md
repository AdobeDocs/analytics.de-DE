...
3. Die Zeit, die zwischen diesen beiden Treffern verstrichen ist, trägt zur verbrachten Zeit bei.

Diese Dimensionen sind nützlich, wenn Sie verstehen möchten, wie lange Besucher mit Ihrer Site im Allgemeinen interagieren.

>[!TIP]
>
>Die verbrachte Zeit erfordert mindestens zwei Treffer während eines Besuchs, um die Zeit zu messen. Besuche, die aus einem einzelnen Treffer bestehen, werden nicht in dieser Dimension angezeigt.
...
Adobe berechnet diese Dimensionen Server-seitig aus der Zeit, die zwischen dem ersten und letzten Treffer des Besuchs verstrichen ist. Es gibt keine Variable zum Festlegen. Sie sind für alle Implementierungen sofort einsatzbereit.
