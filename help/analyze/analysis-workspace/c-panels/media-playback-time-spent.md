...
Das Bedienfeld **[!UICONTROL Verbrachte Zeit bei der Medienwiedergabe]** ermöglicht die Analyse der Medienwiedergabe im Zeitverlauf und bietet Details zum maximalen gleichzeitigen Zugriff sowie die Möglichkeit von Aufschlüsselungen und Vergleichen. 
...
So verwenden Sie das Bedienfeld **[!UICONTROL Verbrachte Zeit bei der Medienwiedergabe]**:

1. Erstellen Sie das Bedienfeld **[!UICONTROL Verbrachte Zeit bei der Medienwiedergabe]**. Informationen zum Erstellen eines Bedienfelds finden Sie unter [Erstellen eines Bedienfelds](panels.md#create-a-panel).
...
Sie können jederzeit ![Bedienfeld „Verbrachte Zeit bei der Medienwiedergabe“ bearbeiten](/help/assets/icons/Edit.svg) auswählen, um das Bedienfeld zu bearbeiten und neu zu erstellen.
