...
Personen im Anmeldeunternehmen können diese Unternehmensvorlagen wie in [Verwenden von Vorlagen](/help/analyze/analysis-workspace/templates/use-templates.md) beschrieben verwenden.
...
Informationen zum Zugreifen auf eine Unternehmensvorlage finden Sie unter [Verwenden von Vorlagen](/help/analyze/analysis-workspace/templates/use-templates.md) im Abschnitt [Zugriff auf und Verwendung einer Vorlage](/help/analyze/analysis-workspace/templates/use-templates.md#access-and-run-a-template).
...
1. Wählen Sie die Option zum **[!UICONTROL Ausblenden der Registerkarte „Vorlagen“]** aus.
