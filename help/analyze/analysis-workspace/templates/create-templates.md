...
Personen im angemeldeten Unternehmen können diese Unternehmensvorlagen verwenden, wie unter &quot;[ verwenden](/help/analyze/analysis-workspace/templates/use-templates.md) beschrieben.
...
1. Wählen Sie in Analysis Workspace die Registerkarte [!UICONTROL **Workspace**] und dann **[!UICONTROL _login_company_name _-Vorlagen]**.
