...
1. Geben Sie im Suchfeld den Namen der Vorlage ein, nach der gesucht werden soll, und wählen Sie sie dann aus der Liste der Vorlagen aus. Sie können in der Liste der Vorlagen auch nach Eigenschaft, eVar und Ereignisnummer suchen. <!-- still true? -->
...
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, welche Sites von Drittanbietern den meisten Traffic zu Ihrer Site leiten. (Ein Link muss auf der externen Site vorhanden sein, und ein Besucher muss darauf klicken, damit das Dimensionselement angezeigt wird.)<br/>**Je nachdem, was Sie erfahren, können Sie** viele Dinge tun, z. B. Inhalte erstellen oder anpassen, um sie besser an die Interessen der Besucher anzupassen, die von den wichtigsten verweisenden Domains kommen. <br/>Diese Vorlage verwendet die Dimension „Verweisende Domain“."
