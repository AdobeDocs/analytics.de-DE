...
1. (Optional) Passen Sie die **[!UICONTROL Kohortentabelleneinstellungen]** an, indem Sie auf das Zahnradsymbol klicken.
...
Wie andere Visualisierungen in Analysis Workspace können Sie eine Kohortenvisualisierung als CSV- oder PDF-Datei herunterladen. Weitere Informationen finden Sie unter [PDF- oder CSV-Dateien herunterladen](/help/analyze/analysis-workspace/curate-share/download-send.md).
