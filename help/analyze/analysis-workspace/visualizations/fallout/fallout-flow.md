...
Unter ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Fallout-Visualisierung](https://experienceleague.adobe.com/de/docs/analytics-learn/tutorials/analysis-workspace/analyzing-customer-journeys/fallout-visualization){target="_blank"} finden Sie ein Demovideo.
