...
* Standard-Traffic: Zeigt die Metrik basierend auf dem angegebenen Zeileneintrag an. Beispiel: In einem Seitenbericht zeigt die Metrik Besuche die Anzahl der Besuche auf einer bestimmten Seite an.
* Standard-Commerce: Metriken wie Umsatz, Bestellungen und Checkouts.
* Gesamtmetriken: Zeigt die Metrik basierend auf dem Berichtsdatumsbereich an, unabhängig von Zeileneintrag. Diese Metrik ist identisch mit der Summe am Ende des jeweiligen Analytics-Berichts.
* Beitrag
* Berechnet

Dimensionen sind nicht numerische Werte und Daten, etwa Geschlecht, Monat, Alter, Treue, Monitorauflösung usw. Dimensionen sind Beschreibungen oder Merkmale von Metrikdaten, die angezeigt und verglichen werden können, z. B. in Aufschlüsselungsberichten.
