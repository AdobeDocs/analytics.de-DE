---
description: In diesen Schritten wird beschrieben, wie Sie Echtzeit-Anfragedaten konfigurieren.
...
1. Klicken Sie im [!UICONTROL Anforderungs-Assistenten, Schritt 1] auf **[!UICONTROL Echtzeitbericht]** > **[!UICONTROL `<report type>`]**
   ...
   Wählen Sie beispielsweise einen Traffic-Bericht. Wenn Sie einen Echtzeitberichtstyp auswählen, werden die Optionen [!UICONTROL Zeitbereich auswählen] angezeigt.
...
1. Wählen Sie einen Zeitraum in Minuten oder Stunden.
   ...
   Echtzeitberichte sind nur für die letzten 20 Stunden verfügbar. Für die Granularität stehen Optionen zur Verfügung, mit denen Sie zwischen einer Granularität von 1 Minute und 30 Minuten wählen können.
