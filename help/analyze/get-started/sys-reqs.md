...
* Einen unterstützten Browser
  ...
  Alle Benutzenden, die auf Adobe Analytics zugreifen, müssen einen unterstützten Browser verwenden. Weitere Informationen finden Sie in den [Systemanforderungen für Adobe Analytics](/help/analyze/get-started/sys-reqs.md).
...
* [Systemanforderungen für die Vorgängerversion von Report Builder](/help/analyze/legacy-report-builder/setup/system-requirements.md)
