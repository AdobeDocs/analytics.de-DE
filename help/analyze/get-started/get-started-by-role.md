...
Die von Ihnen ausgewählte [Implementierungsmethode](/help/implement/home.md) bestimmt, welche Art von Daten erfasst werden können.
...
Informationen zu den einzelnen verfügbaren Methoden finden Sie unter [Implementieren von Adobe Analytics](/help/implement/home.md).
...
|---------|----------|---------|
| Definieren von Admin-Rollen | In Adobe Analytics gibt es verschiedene Arten von Admins | [Administratorrollen in Adobe Analytics](/help/admin/admin-console/admin-roles-in-analytics.md) |
...
| Einrichten von Report Suites und Definieren von Einstellungen für Ihr Unternehmen | Bei einer Report Suite handelt es sich um einen Datenspeicher, mit dem Adobe Analytics Berichte generiert.<p>Admins können außerdem [Virtual Report Suites](/help/components/vrs/vrs-about.md) zur weiteren Segmentierung von Daten einrichten.</p> | <ul><li>[Erstellen einer Report Suite](/help/admin/tools/manage-rs/new-rs/t-create-a-report-suite.md)</li><li>[Übersicht über Unternehmenseinstellungen](/help/admin/tools/company/c-company-settings.md)</li></ul> |
| Importieren von Daten | Sie können Adobe Analytics-Datenquellen nutzen, um zusätzliche Online- oder Offline-Daten für die Berichterstellung zu importieren. | [Datenquellen – Übersicht](/help/import/data-sources/overview.md) |
| Klassifizieren von Daten mit Klassifizierungen | Klassifizierungen ermöglichen es Ihnen, Daten zu klassifizieren, um Variablen besser zu nutzen und so mehr Inhalte in eine Variable einzuschließen. | [Übersicht über Klassifizierungen](/help/components/classifications/classifications-overview.md) |
...
| Protokolldateien | Protokolldateien, die anzeigen, wann sich Benutzende angemeldet haben, was genutzt und worauf zugegriffen wurde, sowie Report Suites und Admin-Änderungen. | [Protokolle](/help/admin/tools/logs.md) |
...
| Warnhinweise | Erstellen und verwalten Sie auf Datenanomalien basierende Warnhinweise sowie „gestapelte“ Warnhinweise, die mehrere Metriken in einem Warnhinweis erfassen. | [Übersicht über Warnhinweise](/help/components/alerts/alerts-overview.md) |
| Datenexport | Mit Data Warehouse und Daten-Feeds können Sie Daten an verschiedene Cloud-Ziele exportieren, z. B. Google Cloud Platform, Azure RBAC, Azure SAS und Amazon S3. | [Leitfaden für Analytics-Exporte](/help/export/home.md) |
...
| Report Builder | Report Builder ist ein Add-in für Microsoft Excel. Mit Report Builder können Sie benutzerdefinierte Anfragen aus Adobe Analytics-Daten erstellen, die in Ihre Excel-Arbeitsblätter eingefügt werden. Anforderungen können dynamisch auf Zellen innerhalb Ihres Arbeitsblatts verweisen, und die Darstellung der Daten in Report Builder lässt sich aktualisieren und anpassen. | [Report Builder](/help/analyze/report-builder/rb-overview.md) |
