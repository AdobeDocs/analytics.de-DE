...
In Adobe Analytics können Sie Basisberichte nach der Anmeldung bei Adobe CX Enterprise hauptsächlich mithilfe von **Analysis Workspace abrufen**. Im linken Menü können Anwender Komponenten per Drag-and-drop verschieben, um einen eigenen Bericht zu erstellen. Sie bietet mehr Freiheit, um exakte Berichtsanforderungen zu erfüllen. Anwender, die mit der Erstellung von Google Analytics-Dashboards und benutzerspezifischen Berichten vertraut sind, finden dieses Layout möglicherweise vertraut.
