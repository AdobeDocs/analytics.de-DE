...
4. Klicken Sie auf **[!UICONTROL Erstellen]**. Aus der resultierenden Tabelle können Sie die betroffenen Bereiche im Vergleich zur vorherigen Woche, zum Monat und zum Jahr in beliebigen Segmenten anzeigen.
